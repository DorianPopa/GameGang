<div class="container">
    ...
    <div class="box">
        ...
        <div>
            ...
            <script>
                var amount_of_songs = "<?php echo $amount_of_songs; ?>";
            </script>
        </div>
        <h3>Amount of songs (via AJAX)</h3>
        <div>
            <button onclick="myFunction()">Click here to get the amount of songs via Ajax (will be displayed in #javascript-ajax-result-box)</button>
            <p id="demo"></p>
        </div>
